    ...
    public static void turn(RobotController rc) throws GameActionException {
        ...
        if (numEnemies > 0 && round >= GameConstants.SETUP_ROUNDS - READY_ROUNDS) {
            ...
            if (defendSpot != null) {
                ...
                if (rc.isMovementReady() && rc.getHealth() < GameConstants.DEFAULT_HEALTH && nearestHealingAlly != null && curr.distanceSquaredTo(nearestHealingAlly) > GameConstants.HEAL_RADIUS_SQUARED) {
